    ...
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6 flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left">
          {/* Logo con fondo semitransparente para contraste */}
          ...
          <p className="text-white/90 text-lg font-light max-w-sm leading-relaxed drop-shadow-lg">
            Sistema integral de gestión para <span className="text-green-400 font-semibold">transporte de personal</span> y <span className="text-green-400 font-semibold">turismo</span>
          </p>
